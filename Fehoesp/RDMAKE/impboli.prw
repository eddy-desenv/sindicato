...
±±ºPrograma  ³ºIMPBOLi  ³Autor  ³    Nava            ³ Data ³ 11/01/08    º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Impressao de Boletos Banco ITAU                             º±±
...
nLin:= 0
lpreview := .t.
oprint:=TMSPrinter():New("Boleto Bancário Banco ITAU")
if lPreview
	oPrint:setup()
endif
Private lContinua:= .T.
...
oprint:SayBitmap( 050,0000,"LOGO341.BMP",100,100 ) 
oprint:Say(100,110,"Banco ITAU S.A.",oFont6,100)
...
oprint:Say(180,0405,"ATÉ O VENCIMENTO, PREFERENCIALMENTE NO ITAÚ OU BANERJ",oFont5,100)
oprint:Say(210,0405,"APÓS O VENCIMENTO, SOMENTE NO ITAÚ OU BANERJ",oFont5,100)
...
oprint:Say(340,0675,"Espécie Doc.",oFont1,100) // Especie Doc.
...
oprint:Say(420,0555,"Espécie Moeda",oFont1,100) // Especie Moeda
...
oprint:Say(500,0030,"Instruções de Responsabilidade do Cedente",oFont1,100) // Instrucoes para o banco
...
oprint:Say(960,1770,"Agência/Código Cedente",oFont1,100)
oprint:Say(1000,1770,cagencia+"/"+cConta +"-"+cDigito,oFont5,150)
oprint:Box(1040,1670,1120,2170) // Cart./Nosso numero
oprint:Say(1040,1770,"Cart./Nosso Número",oFont1,100) // Cart./Nosso numero
...
oprint:Box(1280,1670,1360,2170) // (-)Outras Deduções

oprint:Say(1280,1690,"3 (-) Outras Deduções",oFont1,100) // (-)Outras Deduções
...
oprint:Say(1440,1690,"5 (+)Outros Acréscimos",oFont1,100) // (-)Outros Acrescimos
...
oprint:Say(1760,1370,"Autenticação Mecânica  ",oFont1,100)//1060
...
//oprint:Say(2100,0000,"Banco ITAÚ S.A.",oFont6,100)
oprint:SayBitmap( 2050,0000,"LOGO341.BMP",100,100 ) 
oprint:Say(2100,110,"Banco ITAU S.A.",oFont6,100)
...
oprint:Say(2180,0405,"ATÉ O VENCIMENTO, PREFERENCIALMENTE NO ITAÚ OU BANERJ",oFont5,100)
oprint:Say(2180,1680,"Vencimento",oFont1,100)
oprint:Say(2210,0405,"APÓS O VENCIMENTO, SOMENTE NO ITAÚ OU BANERJ",oFont5,100)
...
oprint:Say(2260,1770,"Agência/Código Cedente",oFont1,100)
...
oprint:Say(2340,0675,"Espécie Doc.",oFont1,100) // Especie Doc.
oprint:Say(2340,0925,"Aceite",oFont1,100) // Aceite
oprint:Say(2340,1275,"Data Processamento",oFont1,100) // Dia Processamento
oprint:Say(2340,1675,"Cart./Nosso Número",oFont1,100) // Cart./Nosso numero
...
oprint:Say(2420,0555,"Espécie Moeda",oFont1,100) // Especie Moeda
...
oprint:Say(2500,0030,"Instruções de Responsabilidade do Cedente",oFont1,100) // Instrucoes para o banco

oprint:Box(2580,1670,2660,2170) // (-)Outras Deduções

oprint:Say(2570,0030,"** Valores Expressos em R$",oFont1,100)
oprint:Say(2580,1690,"3 (-) Outras Deduções",oFont1,100) // (-)Outras Deduções
...
oprint:Say(2740,1690,"5 (+)Outros Acréscimos",oFont1,100) // (-)Outros Acrescimos
...
oprint:Say(3060,1370,"Autenticação Mecânica    Ficha de Compensação",oFont1,100)
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºFun‡„o    ³VALIDPERG º Autor ³ Rdmake        º Data ³  21/08/01        º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
