...
cbtxt := ""
wnrel := ""
cDesc1 := "Este programa irá imprimir O Retorno de Contr.Sindical - Francesinha"
cDesc2 := ""
cDesc3 := ""
cString := "SA1"
tamanho := "G"
...
cabec2 := ""
CABEC1 := "Ersin Nome                                               CNPJ               Natureza   Titulo        Vencto      Vlr.Titulo  Dt.Baixa  Dt.Cred. Vlr. Recebido Situacao No.Bancário     Observacao"
		...
		if dbseek( xFilial()+strzero(val(_cgc),13) )
			...
			IF FOUND()
				...
				if dbseek( xFilial()+subs(TMP->CAMPO,130,02)+"S"+SA1->A1_COD+" DP")
					...
					@ LI,182 psay "Título já existente."
					li++
					qtdje ++
...
//					@ LI,135 PSAY MV_PAR02
					...
					@ LI,158 PSAY SA1->A1_SITUAC
					@ li,167 psay _cgc
					@ LI,182 psay "Título será baixado."
					li++
