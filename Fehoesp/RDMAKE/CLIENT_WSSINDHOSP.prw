...
/* ===============================================================================
WSDL Location    http://200.153.104.250:1234/wstst/SINDHOSP.apw?WSDL
Gerado em        08/13/10 14:27:48
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.080707
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _KONAPUP ; Return  // "dummy" function - Internal Use 
...
WSCLIENT WSSINDHOSP
	...
	WSDATA   oWSAEMPRESA               AS SINDHOSP_SEMPRESA
	...
	WSDATA   oWSVERCADEMPRESULT        AS SINDHOSP_SEMPRESA
	WSDATA   oWSVERCADESCRESULT        AS SINDHOSP_SESCRITO
	WSDATA   oWSVEREMPAUXRESULT        AS SINDHOSP_SEMPRESA
	...
	WSDATA   oWSSEMPRESA               AS SINDHOSP_SEMPRESA
...
WSMETHOD INIT WSCLIENT WSSINDHOSP
	...
	::oWSAEMPRESA        := SINDHOSP_SEMPRESA():New()
	::oWSAESCRITO        := SINDHOSP_SESCRITO():New()
	::oWSVERCADEMPRESULT := SINDHOSP_SEMPRESA():New()
	::oWSVERCADESCRESULT := SINDHOSP_SESCRITO():New()
	::oWSVEREMPAUXRESULT := SINDHOSP_SEMPRESA():New()
...
cSoap += '<AUTENTICAR xmlns="http://200.153.104.250:1234/">'
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://200.153.104.250:1234/AUTENTICAR",; 
	"DOCUMENT","http://200.153.104.250:1234/",,"1.031217",; 
	"http://200.153.104.250:1234/wstst/SINDHOSP.apw")
...
cSoap += '<CADEMPRESA xmlns="http://200.153.104.250:1234/">'
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://200.153.104.250:1234/CADEMPRESA",; 
	"DOCUMENT","http://200.153.104.250:1234/",,"1.031217",; 
	"http://200.153.104.250:1234/wstst/SINDHOSP.apw")
...
cSoap += '<CADESCRIT xmlns="http://200.153.104.250:1234/">'
cSoap += WSSoapValue("AESCRITO", ::oWSAESCRITO, oWSAESCRITO , "SESCRITO", .T. , .F., 0 , NIL, .F.) 
cSoap += WSSoapValue("CROTINA", ::cCROTINA, cCROTINA , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</CADESCRIT>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://200.153.104.250:1234/CADESCRIT",; 
	"DOCUMENT","http://200.153.104.250:1234/",,"1.031217",; 
	"http://200.153.104.250:1234/wstst/SINDHOSP.apw")
...
::Init()
::oWSVERCADEMPRESULT:SoapRecv( WSAdvValue( oXmlRet,"_VERCADEMPRESPONSE:_VERCADEMPRESULT","SEMPRESA",NIL,NIL,NIL,NIL,NIL,NIL) )
...
::Init()
::oWSVEREMPAUXRESULT:SoapRecv( WSAdvValue( oXmlRet,"_VEREMPAUXRESPONSE:_VEREMPAUXRESULT","SEMPRESA",NIL,NIL,NIL,NIL,NIL,NIL) )
...
WSMETHOD NEW WSCLIENT SINDHOSP_SEMPRESA
	::Init()
Return Self

WSMETHOD INIT WSCLIENT SINDHOSP_SEMPRESA
Return

WSMETHOD CLONE WSCLIENT SINDHOSP_SEMPRESA
	Local oClone := SINDHOSP_SEMPRESA():NEW()
	oClone:cCBAIRRO             := ::cCBAIRRO
...
WSMETHOD SOAPSEND WSCLIENT SINDHOSP_SEMPRESA
	Local cSoap := ""
	cSoap += WSSoapValue("CBAIRRO", ::cCBAIRRO, ::cCBAIRRO , "string", .F. , .F., 0 , NIL, .F.) 
...
WSMETHOD SOAPRECV WSSEND oResponse WSCLIENT SINDHOSP_SEMPRESA
	::Init()
	If oResponse = NIL ; Return ; Endif 
	::cCBAIRRO           :=  WSAdvValue( oResponse,"_CBAIRRO","string",NIL,NIL,NIL,"S",NIL,NIL) 
