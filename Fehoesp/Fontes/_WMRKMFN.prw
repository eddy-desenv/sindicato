...
/* ===============================================================================
WSDL Location    http://201.68.45.56:8400/ws/SHEXTRATO.apw?WSDL
Gerado em        10/20/11 11:09:26
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.090116
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _WMRKMFN ; Return  // "dummy" function - Internal Use 
...
cSoap += '<LSTABT xmlns="http://201.68.45.56:8400/">'
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://201.68.45.56:8400/LSTABT",; 
	"DOCUMENT","http://201.68.45.56:8400/",,"1.031217",; 
	"http://201.68.45.56:8400/ws/SHEXTRATO.apw")
...
cSoap += '<LSTPAG xmlns="http://201.68.45.56:8400/">'
cSoap += WSSoapValue("AEMPRESA", ::oWSAEMPRESA, oWSAEMPRESA , "_EMPRESA", .T. , .F., 0 , NIL, .F.) 
cSoap += WSSoapValue("LSIND", ::lLSIND, lLSIND , "boolean", .T. , .F., 0 , NIL, .F.) 
cSoap += WSSoapValue("LCONFNEG", ::lLCONFNEG, lLCONFNEG , "boolean", .T. , .F., 0 , NIL, .F.) 
cSoap += WSSoapValue("LASSOC", ::lLASSOC, lLASSOC , "boolean", .T. , .F., 0 , NIL, .F.) 
